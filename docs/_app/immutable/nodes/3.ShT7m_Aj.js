import{s as k,n as z}from"../chunks/scheduler.CHFMnfDQ.js";import{S as T,i as R,c,s as $,e as y,b as m,d as v,f as w,g as x,h,j as C,m as d,k as _,l as B,a as u,t as g,n as f}from"../chunks/index.B7zo_JMq.js";import{S as F,a as M,M as W}from"../chunks/ScrollMeter.BCPujD7v.js";const E=`
...
`;function H(L){let t,s,a,i,p,o,r,l;return t=new F({props:{title:"IsoCompute Playbook (legacy) | RL Excursions",description:"IsoFLOPs Playbook: Optimally Scaling Sampling Compute for RL Training of LLMs."}}),i=new M({props:{containerSelector:".md-output"}}),r=new W({props:{source:E}}),{c(){c(t.$$.fragment),s=$(),a=y("div"),c(i.$$.fragment),p=$(),o=y("div"),c(r.$$.fragment),this.h()},l(e){m(t.$$.fragment,e),s=v(e),a=w(e,"DIV",{});var n=x(a);m(i.$$.fragment,n),p=v(n),o=w(n,"DIV",{class:!0});var b=x(o);m(r.$$.fragment,b),b.forEach(h),n.forEach(h),this.h()},h(){C(o,"class","layout-xl text-base space-y-12")},m(e,n){d(t,e,n),_(e,s,n),_(e,a,n),d(i,a,null),B(a,p),B(a,o),d(r,o,null),l=!0},p:z,i(e){l||(u(t.$$.fragment,e),u(i.$$.fragment,e),u(r.$$.fragment,e),l=!0)},o(e){g(t.$$.fragment,e),g(i.$$.fragment,e),g(r.$$.fragment,e),l=!1},d(e){e&&(h(s),h(a)),f(t,e),f(i),f(r)}}}class S extends T{constructor(t){super(),R(this,t,null,H,k,{})}}export{S as component};
